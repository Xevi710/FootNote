<header class="grid grid-cols-2 justify-evenly sm:justify-between bg-gray-800 p-4">
	...
	<div class="flex space-x-4">
		...
		@auth
			<div>
				<a class="text-white" href="{{ route('notes.index') }}"> <i class="fas fa-sticky-note"> </i>	FootNote 	</a>
			</div>
			<div>
				<a class="text-white" href="{{ route('notes.nc') }}"> <i class="fas fa-sticky-note"> </i>	Terminadas 	</a>
			</div>
	</div>
