...
@section('content')
	...
	<div class="grid justify-items-start md:justify-items-center p-5">
		...
		<h2 class="text-4xl"> FootNote Register </h2>
		...
		<div class="footerCook">
			<footer class="grid grid-cols-2 justify-evenly sm:justify-between bg-gray-800 p-4 text-white">
				Al entrar en esta aplicación está aceptando las cookies necesarias.
			</footer>
		</div>
