...
@section('content')
	...
	<div class="container mx-auto p-3">
		...
		<div class="text-center mt-4 p-2 mt-4 p-2">
			<h1 class="text-4xl">
				Detalle de la nota: <strong> {{ $notes->title }} </strong>
			</h1>
		</div>
		...
		<div class="w-1/2 mx-auto rounded overflow-hidden grid grid-cols-2 justify-items-center divide-x divide-gray-500  bg-gray-100 my-5">
			...
			<div class="my-4 p-4 justify-items-center">
				...
				<form action="{{ route('notes.completed', $notes) }}">
	...
	<a class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded-full" href="{{ route('notes.index') }}"> Volver a notas </a>
	<a class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded-full" href="{{ route('notes.edit', $notes) }}"> Editar nota </a>
